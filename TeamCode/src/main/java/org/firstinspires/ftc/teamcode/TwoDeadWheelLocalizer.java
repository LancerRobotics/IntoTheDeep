...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 4920.421006346898; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 5525.782870381132; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public TwoDeadWheelLocalizer(HardwareMap hardwareMap, IMU imu, double inPerTick, Pose2d initialPose) {
        par = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, LancersBotConfig.FRONT_LEFT_MOTOR)));
        perp = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, LancersBotConfig.REAR_RIGHT_MOTOR)));
