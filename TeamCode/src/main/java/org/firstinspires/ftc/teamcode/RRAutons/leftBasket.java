    ...
    public void runOpMode() throws InterruptedException {
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(-39.5, -61.5,Math.toRadians(180)))
                        ...
                        .stopAndAdd(new Arm(true, true, 0.6, hardwareMap))
                        .waitSeconds(0.6)
                        ...
                        .strafeTo(new Vector2d(47, -45.5)) // block is 20.5 inches in front of center of bot
                        ...
                        .stopAndAdd(new Arm(false, false, 2.5, hardwareMap))
                        .waitSeconds(2.5)
                        .stopAndAdd(() -> arm.stopMotors())
                        ...
                        .stopAndAdd(new Claw(true, hardwareMap)) // put block in basket
                        .waitSeconds(1)
                        .stopAndAdd(new Arm(false, false,  2.0, 0.0,0.2, hardwareMap))
                        .waitSeconds(2)
                        .stopAndAdd(() -> arm.stopMotors())
                        .stopAndAdd(new Arm(true, false, 0.5, hardwareMap))
                        .waitSeconds(0.5)
